...
##### > Atividade Desafiadora \*\*Desenvolvimento Back-end\*\*
...
##### \_(O desafio consiste em desenvolver um sistema de gestão de pedidos para um e-commerce, permitindo o cadastro e gerenciamento de produtos, clientes e pedidos, além do processamento de pagamentos. O objetivo é criar uma aplicação organizada, eficiente e intuitiva, que facilite o controle das vendas e acompanhe todo o fluxo de um pedido, desde a compra até a confirmação do pagamento.)\_
...
##### 1\. \_(Respeito e Comunicação.)\_

##### 2\. \_(Comprometimento e Responsabilidade.)\_

##### 3\. \_(Colaboração e Participação)\_
...
>>>>>>> 5ab3546 (chore: estrutura inicial do projeto e README com espaço do desafio)
